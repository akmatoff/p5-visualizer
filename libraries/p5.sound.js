    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
        ...
        return (
          ...
          (o.TimelineSignal.prototype.linearRampToValueAtTime = function (
            e,
            t
          ) {
            return (
          ...
          (o.TimelineSignal.prototype.linearRampToValueBetween = function (
            ...
            return (
              this.setRampPoint(t), this.linearRampToValueAtTime(e, i), this
            );
          }),
            ...
            tr: {
              ...
              method: function (e, t, r) {
                ...
                return (
                  ...
                  r &&
                    "0" !== r &&
                    (n += this._beatsToUnits(parseFloat(r) / 4)),
                  n
                );
              },
            },
...
*/
          ...
          amplitude_createClass(Amplitude, [
            {
              ...
              value: function setInput(source, smoothing) {
                ...
                if (smoothing) {
                  this._workletNode.parameters.get("smoothing").value =
                    smoothing;
      ...
      function _possibleConstructorReturn(self, call) {
        if (
          call &&
          (oscillator_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
            ...
            },
            {
              ...
              value: function scale(inMin, inMax, outMin, outMax) {
                ...
                if (arguments.length === 4) {
                  mapOutMin =
                    p5.prototype.map(outMin, inMin, inMax, 0, 1) - 0.5; //find a way to get rid of p5.prototype ?

                  mapOutMax =
                    p5.prototype.map(outMax, inMin, inMax, 0, 1) - 0.5; //find a way to get rid of p5.prototype ?
                } else {
      ...
      p5.Envelope.prototype.ramp = function (unit, secondsFromNow, v1, v2) {
        ...
        var destination2 =
          typeof v2 !== "undefined" ? this.checkExpInput(v2) : undefined; // connect env to unit if not already connected
      ...
      function noise_possibleConstructorReturn(self, call) {
        if (
          call &&
          (noise_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
      ...
      function pulse_possibleConstructorReturn(self, call) {
        if (
          call &&
          (pulse_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
              ...
              value: function start(successCallback, errorCallback) {
                ...
                window.navigator.mediaDevices
                  ...
                  .then(function (stream) {
                    ...
                    self.mediaStream =
                      main.audiocontext.createMediaStreamSource(stream);
      ...
      function filter_possibleConstructorReturn(self, call) {
        if (
          call &&
          (filter_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
      ...
      function eqFilter_possibleConstructorReturn(self, call) {
        if (
          call &&
          (eqFilter_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
        ...
        (function (_Effect) {
          ...
          eq_createClass(EQ, [
            ...
            },
            {
              key: "dispose",
              value: function dispose() {
                eq_get(eq_getPrototypeOf(EQ.prototype), "dispose", this).call(
                  this
                );
      ...
      function panner3d_possibleConstructorReturn(self, call) {
        if (
          call &&
          (panner3d_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
      ...
      function delay_possibleConstructorReturn(self, call) {
        if (
          call &&
          (delay_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
      ...
      function reverb_possibleConstructorReturn(self, call) {
        if (
          call &&
          (reverb_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
            ...
            },
            {
              ...
              value: function syncedStart(otherLoop, timeFromNow) {
                ...
                if (!otherLoop.isPlaying) {
                  ...
                  var time =
                    otherLoop.clock._nextTick - main.audiocontext.currentTime;
      ...
      function compressor_possibleConstructorReturn(self, call) {
        if (
          call &&
          (compressor_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
        ...
        (function (_Effect) {
          ...
          compressor_createClass(Compressor, [
            ...
            },
            {
              ...
              value: function dispose() {
                compressor_get(
                  compressor_getPrototypeOf(Compressor.prototype),
                  "dispose",
                  this
                ).call(this);
      ...
      function distortion_possibleConstructorReturn(self, call) {
        if (
          call &&
          (distortion_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
        ...
        (function (_Effect) {
          ...
          distortion_createClass(Distortion, [
            ...
            },
            {
              ...
              value: function dispose() {
                distortion_get(
                  distortion_getPrototypeOf(Distortion.prototype),
                  "dispose",
                  this
                ).call(this);
      ...
      function monosynth_possibleConstructorReturn(self, call) {
        if (
          call &&
          (monosynth_typeof(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
          ...
          monosynth_createClass(MonoSynth, [
            {
              ...
              value: function play(note, velocity, secondsFromNow, susTime) {
                ...
                this.triggerRelease(
                  ~~secondsFromNow + (susTime || DEFAULT_SUSTAIN)
                );
              },
              /**
               *  Trigger the Attack, and Decay portion of the Envelope.
            ...
            },
            {
              ...
              value: function dispose() {
                monosynth_get(
                  monosynth_getPrototypeOf(MonoSynth.prototype),
                  "dispose",
                  this
                ).call(this);
          ...
          onsetDetect_createClass(OnsetDetect, [
            {
              ...
              value: function update(fftObject, callback) {
                this.energy =
                  fftObject.getEnergy(this.freqLow, this.freqHigh) / 255;
